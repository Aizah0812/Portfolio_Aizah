...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_fol25bq", // Your Service ID
        "template_xnfewwn", // Your Template ID
        form.current,
        "ATsyWrsMwEdRqsIvu", // Your Public Key
      )
      .then(
        () => {
          setIsSending(false);
        ...
        <div className="lg:w-1/3 flex flex-col justify-center space-y-8">
          ...
          <div className="flex items-center gap-4 px-6">
            ...
            <div>
              ...
              <p className="text-white font-medium">aizahsarfaraz0786@gmail.com</p>
            </div>
          </div>
        </div>
